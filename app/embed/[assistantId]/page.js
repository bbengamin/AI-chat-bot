...
function Embed({ params: { assistantId } }) {
    ...
    const askAssistant = async () => {
        ...
        await openai.beta.threads.messages.create(getThread.id, { role: "user", content: getQuestion });
        const getRun = await openai.beta.threads.runs.create(getThread.id, { assistant_id: assistantId });
        setRun(getRun);
